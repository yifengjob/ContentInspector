...
const enhancedOdtExtract = composeDecorators(
    odtExtractor.extract.bind(odtExtractor),
    [
...
const enhancedOdsExtract = composeDecorators(
    odsExtractor.extract.bind(odsExtractor),
    [
        (fn) => withTimeout(fn, { timeoutMs: 30000 }),
...
const enhancedOdpExtract = composeDecorators(
    odpExtractor.extract.bind(odpExtractor),
    [
        (fn) => withTimeout(fn, { timeoutMs: 30000 }),
